...
function showRecipeSuggestions(addRecipeInput, results)
{
	...
	var customRecipe = new Defines.Recipe();
...
function onRecipeSearchEnterPressed()
{
	...
	var newDateRecipe = new Defines.DateRecipe();
...
exports.fillCalendarView = fillCalendarView;
exports.refreshDayRecipes = refreshDayRecipes;
